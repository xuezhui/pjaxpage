var egret; (function(b) {
    ...
    var d = function() {
        ...
        a.fatalWithErrorId = function(e) {
            ...
            l.unshift(e); (l = c.apply(null, l)) ? a.fatal(l) : a.warning(c( - 1, e))
        };
        a.infoWithErrorId = function(e) {
            for (var l = [], b = 1; b < arguments.length; b++) l[b - 1] = arguments[b];
            l.unshift(e); (l = c.apply(null, l)) ? a.info(l) : a.warning(c( - 1, e))
        };
        a.warningWithErrorId = function(e) {
            for (var l = [], b = 1; b < arguments.length; b++) l[b - 1] = arguments[b];
            l.unshift(e); (l = c.apply(null, l)) ? a.warning(l) : a.warning(c( - 1, e))
        };
...
function(b, c) {
    ...
    var c = function() {
        ...
        d.push = function(a, e) {
            var l;
            l = d.__freeList.length ? d.__freeList.pop() : new b.RenderCommand;
            l.callback = a;
            l.thisObject = e;
...
function(b, c) {
    ...
    var c = function(d) {
        function a(e, a, b, h, c, f, k, n, p, q) {
            void 0 === a && (a = !0);
            void 0 === b && (b = !0);
            void 0 === h && (h = 0);
            void 0 === c && (c = 0);
        ...
        a.dispatchTouchEvent = function(e, l, m, d, c, f, k, n, p) {
            void 0 === m && (m = 0);
            void 0 === d && (d = 0);
            void 0 === c && (c = 0);
            void 0 === f && (f = !1);
...
function(b, c) {
    ...
    var c = function(d) {
        ...
        a.dispatchTextEvent = function(e, l, m) {
            ...
            d.text = m;
            b.Event._dispatchByTarget(a, e, l, d)
        };
        a.LINK = "link";
        return a
    } (b.Event);
...
function(b, c) {
    ...
    var c = function(d) {
        ...
        __extends(a, d);
        a.dispatchProgressEvent = function(e, l, m, d) {
            void 0 === m && (m = 0);
            void 0 === d && (d = 0);
            b.Event._dispatchByTarget(a, e, l, {
                bytesLoaded: m,
    ...
    var c = function(d) {
        ...
        a.prototype._removeEventBin = function(e, a, b, d, c) {
            ...
            for (var f = e.length; c < f; c++) {
                var k = e[c];
                if (k.listener === a && k.thisObject === b && k.display == d) return e.splice(c, 1),
                !0
            }
            return ! 1
        };
...
function(b, c) {
    ...
    var c = function(d) {
        ...
        a.prototype.append = function(e, a, b, d, c, f) {
            ...
            p = this.c,
            q = this.d;
            if (1 != e || 0 != a || 0 != b || 1 != d) this.a = e * k + a * p,
            this.b = e * n + a * q,
            this.c = b * k + d * p,
            this.d = b * n + d * q;
            this.tx = c * k + f * p + this.tx;
            this.ty = c * n + f * q + this.ty;
            return this
        };
        a.prototype.prependTransform = function(e, a, m, d, c, f, k, n, p) {
            if (c % 360) {
            ...
            if (n || p) this.tx -= n,
            this.ty -= p;
            f || k ? (this.prepend(q * m, c * m, -c * d, q * d, 0, 0), this.prepend(b.NumberUtils.cos(k), b.NumberUtils.sin(k), -b.NumberUtils.sin(f), b.NumberUtils.cos(f), e, a)) : this.prepend(q * m, c * m, -c * d, q * d, e, a);
            return this
        };
        a.prototype.appendTransform = function(e, a, m, d, c, f, k, n, p) {
            if (c % 360) {
                var q = b.NumberUtils.cos(c);
                c = b.NumberUtils.sin(c)
            } else q = 1,
            c = 0;
            f || k ? (this.append(b.NumberUtils.cos(k), b.NumberUtils.sin(k), -b.NumberUtils.sin(f), b.NumberUtils.cos(f), e, a), this.append(q * m, c * m, -c * d, q * d, 0, 0)) : this.append(q * m, c * m, -c * d, q * d, e, a);
...
function(b, c) {
    ...
    d = function() {
        ...
        e.prototype.init = function(e) {};
        e.prototype._apply = function(e, a, l) {};
        e.prototype.setEgretSize = function(e, a, l, m, d, p) {
            void 0 === p && (p = 0);
    ...
    l = function(e) {
        ...
        a.prototype._apply = function(e, a, l) {
            ...
            this.setEgretSize(a, d / c, l * c, b, l * (1 - c) / 2);
            e._scaleX = m * c;
            e._scaleY = m * c
        };
        return a
    ...
    l = function(e) {
        ...
        a.prototype._apply = function(e, a, l) {
            ...
            this.setEgretSize(a, l / 1, 1 * d, c, b, e._offSetY);
            e._scaleX = 1 * h;
            e._scaleY = 1 * h
        };
        return a
...
function(b, c) {
    ...
    var c = function(d) {
        ...
        a.prototype.drawImage = function(e, l, m, d, c, f, k, n, p, q, r) {
            void 0 === r && (r = void 0);
            k = k || 0;
            n = n || 0;
            ...
            if (null != t && 0 != f && 0 != c && 0 != p && 0 != q) {
                ...
                if (0 != this._drawAreaList.length && b.MainContext.instance.rendererContext._cacheCanvasContext) {
                    ...
                    s.destWidth = p;
                    s.destHeight = q;
                    for (var u = this.getDrawAreaList(), w = 0; w < u.length; w++) if (!this.ignoreRender(l, u[w], s.destX, s.destY)) {
                        e.drawImage(t, m, d, c, f, k, n, p, q, r);
                        break
                    }
                } else e.drawImage(t, m, d, c, f, k, n, p, q, r)
            }
        };
...
function(b, c) {
    ...
    var c = function(d) {
        ...
        a.prototype.drawCacheTexture = function(e) {
            ...
            e.setAlpha(this.worldAlpha, this.blendMode);
            e.setTransform(this._worldTransform);
            b.RenderFilter.getInstance().drawImage(e, this, 0, 0, c, d, a, m, c, d);
            return ! 0
        };
        ...
        a.prototype.getBounds = function(e, a) {
            ...
            d = this._hasWidthSet ? this._explicitWidth: m.width,
            ...
            k = 0,
            n = 0;
            a && (0 != this._anchorX || 0 != this._anchorY ? (k = d * this._anchorX, n = c * this._anchorY) : (k = this._anchorOffsetX, n = this._anchorOffsetY));
            this._cacheBounds.initialize(f - k, m - n, d, c);
            d = this._cacheBounds;
            e || (e = new b.Rectangle);
        ...
        a.prototype._getConcatenatedMatrix = function() {
            for (var e = a.identityMatrixForGetConcatenated.identity(), l = this; null != l;) {
                if (0 != l._anchorX || 0 != l._anchorY) {
                    ...
                    e.prependTransform(l._x, l._y, l._scaleX, l._scaleY, l._rotation, l._skewX, l._skewY, m.width * l._anchorX, m.height * l._anchorY)
        ...
        a.prototype._getMatrix = function(e) {
            ...
            d ? (e.append(d.a, d.b, d.c, d.d, d.tx, d.ty), e.append(1, 0, 0, 1, -a, -m)) : e.appendTransform(this._x, this._y, this._scaleX, this._scaleY, this._rotation, this._skewX, this._skewY, a, m);
            return e
        };
        ...
        a.prototype.addEventListener = function(e, l, m, c, g) {
            void 0 === c && (c = !1);
            void 0 === g && (g = 0);
            d.prototype.addEventListener.call(this, e, l, m, c, g); ((c = e == b.Event.ENTER_FRAME) || e == b.Event.RENDER) && this._insertEventBin(c ? a._enterFrameCallBackList: a._renderCallBackList, l, m, g, this)
        };
        a.prototype.removeEventListener = function(e, l, m, c) {
            void 0 === c && (c = !1);
            d.prototype.removeEventListener.call(this, e, l, m, c); ((c = e == b.Event.ENTER_FRAME) || e == b.Event.RENDER) && this._removeEventBin(c ? a._enterFrameCallBackList: a._renderCallBackList, l, m, this)
        };
        a.prototype.dispatchEvent = function(e) {
        ...
        a.getTransformBounds = function(e, a) {
            ...
            t = p,
            s = q,
            u = q; (b = k + p) < r ? r = b: b > t && (t = b); (b = k + n + p) < r ? r = b: b > t && (t = b); (b = n + p) < r ? r = b: b > t && (t = b); (d = c + q) < s ? s = d: d > u && (u = d); (d = c + f + q) < s ? s = d: d > u && (u = d); (d = f + q) < s ? s = d: d > u && (u = d);
    ...
    c = function() {
        ...
        b.prototype.updateColor = function(a, e, b, d, c, g, f, k) {};
        return b
    } ();
    b.ColorTransform = c;
...
function(b, c) {
    ...
    var c = function(d) {
        ...
        a.prototype._doAddChild = function(e, l, d) {
            void 0 === d && (d = !0);
            if (e == this) return e;
            if (0 > l || l > this._children.length) return b.Logger.fatalWithErrorId(1007),
            e;
            var c = e._parent;
            if (c == this) return this.doSetChildIndex(e, l),
            e;
            if (c) {
            ...
            if (this._stage) for (e._onAddToStage(), l = a.__EVENT__ADD_TO_STAGE_LIST; 0 < l.length;) c = l.shift(),
            d && c.dispatchEventWith(b.Event.ADDED_TO_STAGE);
            e._setDirty();
            this._setSizeDirty();
            return e
        };
        ...
        a.prototype._updateTransform = function() {
            if (this._visible) {
                ...
                m = this._children,
                c = m.length; a < c; a++) m[a]._updateTransform();
...
function(b, c) {
    ...
    var c = function(d) {
        ...
        a.registerScaleMode = function(e, l, d) {
            a.SCALE_MODE_ENUM[e] && !d ? b.Logger.warningWithErrorId(1009, e) : a.SCALE_MODE_ENUM[e] = l
        };
...
function(b, c) {
    ...
    var c = function(d) {
        ...
        a.prototype.dispatchPropagationEvent = function(e) {
            for (var a = [], b = e._target, d = 0; b;) b == this && (d = a.length),
            a.push(b),
            b = b.parent;
            b = a.slice(0, d);
            b = b.reverse();
    ...
    var c = function(d) {
        ...
        a._drawBitmap = function(e, b, d, c) {
            ...
            if (g) {
                ...
                if ("scale" == c.fillMode) {
                    ...
                    if (n && f - n.width < b && k - n.height < d) a.drawScale9GridImage(e, c, n, b, d);
                    else {
                        var n = g._offsetX,
                        p = g._offsetY,
                        q = g._bitmapWidth || f,
        ...
        a.drawScale9GridImage = function(e, a, d, c, g) {
            ...
            if (k && d) {
                ...
                c -= n - t;
                g -= p - s;
                if (!e.drawImageScale9(k, q, r, t, s, k._offsetX, k._offsetY, c, g, d)) {
                    n = k._offsetX / f;
                    p = k._offsetY / f;
                    ...
                    s = g - (s - d.bottom),
                    t = c - (t - d.right);
                    k.drawImage(e, a, q, r, d.x, d.y, n, p, d.x, d.y);
                    k.drawImage(e, a, u, r, d.width, d.y, z, p, t - d.x, d.y);
                    k.drawImage(e, a, w, r, v, d.y, n + t, p, c - t, d.y);
                    k.drawImage(e, a, q, y, d.x, d.height, n, A, d.x, s - d.y);
                    k.drawImage(e, a, u, y, d.width, d.height, z, A, t - d.x, s - d.y);
                    k.drawImage(e, a, w, y, v, d.height, n + t, A, c - t, s - d.y);
                    k.drawImage(e, a, q, f, d.x, x, n, p + s, d.x, g - s);
                    k.drawImage(e, a, u, f, d.width, x, z, p + s, t - d.x, g - s);
                    k.drawImage(e, a, w, f, v, x, n + t, p + s, c - t, g - s)
                }
            }
        };
        a.prototype._measureBounds = function() {
...
function(b, c) {
    ...
    var c = function(d) {
        ...
        a.prototype._render = function(e) {
            ...
            if (0 != d) {
                ...
                g = c._getFirstCharHeight(), g = Math.ceil(g * a.EMPTY_FACTOR), f = 0, k = this._hasHeightSet ? this._explicitHeight: Number.POSITIVE_INFINITY, n = this._lineHeights, p = 0; p < d; p++) {
                    var q = n[p];
                    if (0 < p && f + q > k) break;
        ...
        a.prototype._getTextLines = function() {
            ...
            n = this._hasWidthSet ? this._explicitWidth: Number.POSITIVE_INFINITY, p = this._font, q = p._getFirstCharHeight(), r = Math.ceil(q * a.EMPTY_FACTOR), t = this._text.split(/(?:\r\n|\r|\n)/), s = t.length, u = !0, w = 0; w < s; w++) {
                for (var v = t[w], y = v.length, x = 0, z = 0, A = !0, C = 0; C < y; C++) {
                    ...
                    u && (f = Math.min(G, f));
                    k && 0 < C && z + B > n ? (e.push(v.substring(0, C)), l.push(x), c += x, d = Math.max(z, d), v = v.substring(C), y = v.length, C = 0, z = B, x = E) : (z += B, x = Math.max(E, x))
                }
                u && (u = !1);
                e.push(v);
                l.push(x);
    ...
    var c = function() {
        ...
        d.prototype.arc = function(a, e, b, d, c, g) {};
        ...
        d.prototype.lineStyle = function(a, e, b, d, c, g, f, k) {};
        ...
        a.prototype._measureBounds = function() {
            ...
            f = 0; f < g; f++) {
                ...
                if (k._visible) {
                    ...
                    n = n.height,
                    k = k._getMatrix(),
                    k = b.DisplayObject.getTransformBounds(b.Rectangle.identity.initialize(p, q, r, n), k),
                    p = k.x,
                    q = k.y,
                    r = k.width + k.x,
                    k = k.height + k.y;
    ...
    var c = function(d) {
        ...
        a.prototype.changeToPassText = function(e) {
            if (this._displayAsPassword) {
                for (var a = "",
                b = 0,
                d = e.length; b < d; b++) switch (e.charAt(b)) {
                case "\n":
                    a += "\n";
                    break;
                case "\r":
        ...
        a.prototype._getLinesArr = function() {
            ...
            this._isArrayChanged = !1;
            var a = this._textArr,
            l = b.MainContext.instance.rendererContext;
            this._linesArr = [];
            ...
            p = a.length; n < p; n++) {
                ...
                for (var r = q.text.toString().split(/(?:\r\n|\r|\n)/), t = 0, s = r.length; t < s; t++) {
                    ...
                    if ("" != r[t]) {
                        this._isFlow && l.setupFont(this, q.style);
                        var u = l.measureText(r[t]);
                        if (this._hasWidthSet) if (c + u <= this._explicitWidth) k.elements.push({
                            width: u,
                            text: r[t],
                            style: q.style
                        }),
                    ...
                    if (t < r.length - 1) {
                        ...
                        if (this._type == b.TextFieldType.INPUT && !this._multiline) return this._numLines = d.length,
                        d;
                        f++
                    }
                }
                n == a.length - 1 && k && (k.width = c, k.height = g, this._textMaxWidth = Math.max(this._textMaxWidth, c), this._textMaxHeight += g)
            }
        ...
        a.prototype.drawText = function(a) {
            ...
            if (0 != this._textMaxWidth) {
                ...
                n = this._numLines; f < n; f++) {
                    ...
                    for (var k = Math.round((c - p.width) * h), r = 0, t = p.elements.length; r < t; r++) {
                        var s = p.elements[r],
                        u = s.style.size || this._size;
                        this._type == b.TextFieldType.INPUT ? a.drawText(this, s.text, k, g + (q - u) / 2, s.width) : a.drawText(this, s.text, k, g + (q - u) / 2, s.width, s.style);
                        k += s.width
                    }
        ...
        a.prototype.onTapHandler = function(a) {
            if (this._type != b.TextFieldType.INPUT && (a = this._getTextElement(a.localX, a.localY), null != a && (a = a.style) && a.href && a.href.match(/^event:/))) {
                var d = a.href.match(/^event:/)[0];
                b.TextEvent.dispatchTextEvent(this, b.TextEvent.LINK, a.href.substring(d.length))
            }
        };
        a.prototype._getTextElement = function(a, b) {
            var d = this._getHit(a, b),
            c = this._getLinesArr();
            return d && c[d.lineIndex] && c[d.lineIndex].elements[d.textElementIndex] ? c[d.lineIndex].elements[d.textElementIndex] : null
        };
        a.prototype._getHit = function(a, b) {
            ...
            if (0 === c) return null;
            d = d[c - 1];
            for (f = g = 0; f < d.elements.length; f++) if (k = d.elements[f], g + k.width < a) g += k.width;
            else return {
                lineIndex: c - 1,
                textElementIndex: f
            };
...
function(b, c) {
    ...
    var c = function(d) {
        ...
        a.prototype.createTexture = function(a, d, c, h, g, f, k, n, p) {
            void 0 === f && (f = 0);
            void 0 === k && (k = 0);
...
function(b, c) {
    ...
    var c = function(d) {
        ...
        a.prototype._updateTransform = function() {
            ...
            if (this._isFirst || a != k.a || d != k.b || c != k.c || h != k.d || g != k.tx || f != k.ty) {
                this._isFirst = !1;
                a = this._text.localToGlobal();
...
function(b, c) {
    ...
    var c = function(b) {
        function a(a, l) {
            ...
            "string" == typeof l ? this.charList = this.parseConfig(l) : l && l.hasOwnProperty("frames") ? this.charList = l.frames: this.charList = {}
        }
        __extends(a, b);
        a.prototype.getTexture = function(a) {
        ...
        a.prototype.parseConfig = function(a) {
            ...
            c = 4; c < 4 + b; c++) {
                ...
                k.h = this.getConfigByKey(g, "height");
    ...
    var c = function(d) {
        ...
        a.prototype._render = function(e) {
            ...
            if (this._texture_to_render = b) {
                ...
                k = Math.round(g),
                n = Math.round(f);
                a.renderFilter.drawImage(e, this, b._bitmapX, b._bitmapY, g, f, d, c, k, n)
            }
        };
        a.prototype._measureBounds = function() {
...
function(b, c) {
    ...
    var c = function(d) {
        ...
        a.prototype.load = function(a) {
            ...
            console.log(123123, b.MainContext.instance.netContext.proceed)
        };
        a.prototype.__recycle = function() {
...
function(b, c) {
    ...
    var c = function(d) {
        ...
        a.prototype.drawImage = function(a, b, d, c, g, f, k, n, p, q) {
            this.profiler.onDrawImage()
        };
        a.prototype.drawImageScale9 = function(a, b, d, c, g, f, k, n, p, q) {
            return ! 1
        };
...
function(b, c) {
    ...
    var c = function() {
        ...
        d.findByPath = function(a, e, b) {
            ...
            f = 0; f < g; f++) {
                var k = a[f];
                k.localName == h && (c ? b.push(k) : d.findByPath(k, e, b))
            }
        };
    ...
    var d = function() {
            ...
            for (var d = []; a.length > b;) {
                ...
                if (this.inRange(c, 55296, 57343)) this.encoderError(c);
                    ...
                    for (d.push(this.div(c, Math.pow(64, g)) + f); 0 < g;) {
                        var k = this.div(c, Math.pow(64, g - 1));
                        d.push(128 + k % 64);
                        g -= 1
                    }
                }
        ...
        a.prototype.decodeUTF8 = function(a) {
            ...
            n = 0; a.length > b;) {
                ...
                else if (this.inRange(c, 128, 191)) if (k += 1, g += (c - 128) * Math.pow(64, f - k), k !== f) c = null;
                else {
                    var p = g,
                    q = n,
                    n = k = f = g = 0;
    ...
    var c = function(d) {
        ...
        a.prototype.setPosition = function(a, b) {
            ...
            if (this._target) if (c) this._updateTargetProps(null, 1);
                ...
                for (var f = 0,
                k = this._steps.length; f < k && !(this._steps[f].t > d); f++);
                f = this._steps[f - 1];
        ...
        a.prototype._updateTargetProps = function(e, b) {
            ...
            for (var k in this._initQueueProps) {
                ...
                var n = !1;
                if (f = a._plugins[k]) for (var p = 0,
                q = f.length; p < q; p++) {
                    var r = f[p].tween(this, k, g, d, c, b, !!e && d == c, !e);
                    r == a.IGNORE ? n = !0 : g = r
                }
                n || (this._target[k] = g)
            }
        ...
        a.prototype._appendQueueProps = function(e) {
            ...
            for (k in e) if (void 0 === this._initQueueProps[k]) {
                d = this._target[k];
                if (b = a._plugins[k]) for (c = 0, g = b.length; c < g; c++) d = b[c].init(this, k, d);
                this._initQueueProps[k] = this._curQueueProps[k] = void 0 === d ? null: d
            }
            for (k in e) {
                d = this._curQueueProps[k];
                if (b = a._plugins[k]) for (f = f || {},
                c = 0, g = b.length; c < g; c++) b[c].step && b[c].step(this, k, d, e[k], f);
...
function(b, c) {
    ...
    var c = function(d) {
        function a(a, b) {
            ...
            h = this;
            this.drawCanvasContext.setTransform = function(a, e, b, d, l, q) {
                h._matrixA = a;
                h._matrixB = e;
                h._matrixC = b;
                h._matrixD = d;
                h._matrixTx = l;
                h._matrixTy = q;
                c.call(h.drawCanvasContext, a, e, b, d, l, q)
            };
            this._matrixA = 1;
        ...
        a.prototype.drawImage = function(a, c, m, h, g, f, k, n, p, q) {
            void 0 === q && (q = void 0);
            var r = a._bitmapData;
            f += this._transformTx;
            k += this._transformTy;
            var t = b.getTimer();
            void 0 === q ? this.drawCanvasContext.drawImage(r, c, m, h, g, f, k, n, p) : this.drawRepeatImage(a, c, m, h, g, f, k, n, p, q);
            d.prototype.drawImage.call(this, a, c, m, h, g, f, k, n, p, q);
            this.renderCost += b.getTimer() - t
        };
        a.prototype.drawRepeatImage = function(a, d, c, h, g, f, k, n, p, q) {
            if (void 0 === a.pattern) {
        ...
        a.prototype.onRenderFinish = function() {
            ...
            c = b.RenderFilter.getInstance().getDrawAreaList(), h = 0, g = c.length; h < g; h++) {
                ...
                k + p > a && (p = a - k);
                n + f > d && (f = d - n);
                0 < p && 0 < f && this.canvasContext.drawImage(this._cacheCanvas, k, n, p, f, k, n, p, f)
            }
        };
        return a
    } (b.RendererContext);
...
var egret_h5_graphics; (function(b) {
    ...
    b.arc = function(b, a, e, l, m, h) {
        this.commandQueue.push(new c(function(a, b, e, d, c, l) {
            var m = this.renderContext;
            this.canvasContext.beginPath();
            this.canvasContext.arc(m._transformTx + a, m._transformTy + b, e, d, c, l || !1)
        },
        this, [b, a, e, l, m, h]))
    };
    b.drawRoundRect = function(b, a, e, l, m, h) {
        this._pushCommand(new c(function(a, b, e, d, c, l) {
            var m = this.renderContext;
            a = m._transformTx + a;
            b = m._transformTy + b;
            c /= 2;
    ...
    b.drawEllipse = function(b, a, e, l) {
        this._pushCommand(new c(function(a, b, e, d) {
            ...
            this.canvasContext.beginPath();
            this.canvasContext.moveTo((a + e) / l, b / d);
            this.canvasContext.arc(a / l, b / d, c, 0, 2 * Math.PI);
            this.canvasContext.closePath();
    ...
    b.lineStyle = function(b, a, e, l, m, h, g, f) {
        void 0 === b && (b = NaN);
        void 0 === a && (a = 0);
        void 0 === e && (e = 1);
        void 0 === l && (l = !1);
    ...
    var c = function(d) {
        ...
        a.prototype.initAll = function() {
            ...
            b.RenderTexture.prototype.drawToTexture = function(a, d, c) {
                ...
                this.renderContext.onRenderFinish();
                f._drawAreaList = n;
                this._sourceWidth = d / k * c;
                this._sourceHeight = h / k * c;
        ...
        a.prototype.drawRepeatImage = function(a, d, c, h, g, f, k, n, p, q) {
            ...
            h *= q;
            for (g *= q; f < n; f += h) for (var r = k; r < p; r += g) {
        ...
        a.prototype.drawImage = function(a, b, d, c, g, f, k, n, p, q) {
            void 0 === q && (q = void 0);
            if (!this.contextLost) if (void 0 !== q) this.drawRepeatImage(a, b, d, c, g, f, k, n, p, q);
            else {
...
var egret_webgl_graphics; (function(b) {
    ...
    b.drawCircle = function(b, a, e) {};
    b.drawRoundRect = function(b, a, e, c, m, h) {};
    b.drawEllipse = function(b, a, e, c) {};
    b.lineStyle = function(b, a, e, c, m, h, g, f) {};
    b.lineTo = function(b, a) {};
...
function(b, c) {
    ...
    var c = function(d) {
        ...
        a.prototype.getLocation = function(a, d) {
            ...
            k.x = (c - g) / b.StageDelegate.getInstance().getScaleX();
        ...
        d.prototype.parseConfig = function(a, b) {
            if (a) {
                ...
                if (d = a.groups) for (c = d.length, h = 0; h < c; h++) {
                    for (var f = d[h], k = [], n = f.keys.split(","), p = n.length, q = 0; q < p; q++) g = n[q].trim(),
    ...
    var c = function(d) {
        ...
        a.prototype.removeGroupName = function(a) {
            for (var b in this.priorityQueue) {
                for (var d = this.priorityQueue[b], c = d.length, g = 0, f = !1, c = d.length, k = 0; k < c; k++) {
                    if (d[k] == a) {
                        d.splice(g, 1);
                        f = !0;
                        break
...
function(b, c) {
    ...
    var c = function(d) {
        ...
        a.prototype.parseSpriteSheet = function(a, b, d) {
            ...
            for (f in b) {
                var k = b[f];
                a = c.createTexture(f, k.x, k.y, k.w, k.h, k.offX, k.offY, k.sourceW, k.sourceH);
...
function(b, c) {
    ...
    var c = function(a) {
        ...
        d.prototype.loadDelayGroups = function() {
            ...
            d = 0; d < b; d++) {
                var c = a[d];
                this.loadGroup(c.name, c.priority)
            }
        };
    ...
    return {
        ...
        ready: function(b) {
            if (b && "function" == typeof b) {
                ...
                "undefined" == typeof window.WeixinJSBridge ? document.addEventListener ? document.addEventListener("WeixinJSBridgeReady", d, !1) : document.attachEvent && (document.attachEvent("WeixinJSBridgeReady", d), document.attachEvent("onWeixinJSBridgeReady", d)) : d()
            }
        },
        shareToTimeline: function(b, c) {
            c = c || {};
            var d = function(a) {
            ...
            function(a) {
                c.async && c.ready ? (window._wx_loadedCb_ = c.dataLoaded || new Function, 0 < window._wx_loadedCb_.toString().indexOf("_wx_loadedCb_") && (window._wx_loadedCb_ = new Function), c.dataLoaded = function(a) {
                    window._wx_loadedCb_(a);
                    d(a)
                },
                c.ready && c.ready(a)) : (c.ready && c.ready(a), d(b))
            })
        },
        shareToWeibo: function(b, c) {
            c = c || {};
            var d = function(a) {
        ...
        getNetworkType: function(b) {
            b && "function" == typeof b && WeixinJSBridge.invoke("getNetworkType", {},
            function(c) {
                b(c.err_msg)
            })
        },
        imagePreview: function(b, c) {
            b && c && 0 != c.length && WeixinJSBridge.invoke("imagePreview", {
                current: b,
                urls: c
            })
        },
...
WeixinShareInfo = function() {},
WeixinShareCallbackInfo = function() {},
__extends = this.__extends ||
function(b, c) {
    function d() {
        this.constructor = b
...
YYLib; (function(b) {
    ...
    b.YYEvents = c;
    c.prototype.__class__ = "YYLib.YYEvents"
})(YYLib || (YYLib = {}));
var __extends = this.__extends ||
function(b, c) {
    function d() {
...
Grid = function(b) {
    ...
    c.prototype.createViews = function() {
        var b = YYLib.Util.getBitmap(this.texture);
        this.width = b.width;
        this.height = b.height;
        var a = YYLib.Util.getTextField(this.opts, this.fontSize, 16357376, null, "left"),
        c = YYLib.Util.getTextField(this.upcase, 36, 12943931);
        ...
        this.addChild(c);
        this.addChild(a);
        this.ansRight = YYLib.Util.getBitmap("sprite.trueIcon");
        this.ansError = YYLib.Util.getBitmap("sprite.falseIcon");
        this.ansError.x = this.ansRight.x = this.width - this.ansRight.width - 8;
        this.ansError.y = this.ansRight.y = 8;
        this.ansError.alpha = this.ansRight.alpha = 0;
        this.ansError.name = "ansError";
        this.ansRight.name = "ansRight";
        this.addChild(this.ansError);
        this.addChild(this.ansRight);
        this.touchChildren = !1;
        this.touchEnabled = !0;
        this.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouched, this)
    };
    c.prototype.onTouched = function(b) {
        this.opts == DataProxy.getInstance().curLvOk ? (b = egret.Tween.get(this.ansRight), b.to({
            alpha: 1
        },
        300), b.call(function() {
            var a = new YYLib.YYEvents("ansRight");
            DataProxy.getInstance().gameContainer.dispatchEvent(a)
        })) : (b = egret.Tween.get(this.ansError), b.to({
            alpha: 1
        },
        300), b.call(function() {
            var a = new YYLib.YYEvents("ansError", !1, !1, {
                answer: DataProxy.getInstance().curLvOk
            });
            DataProxy.getInstance().gameContainer.dispatchEvent(a)
        }));
        for (b = 0; b < this.parent.numChildren; b++) {
            var a = this.parent.getChildAt(b);
            a.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouched, a)
        }
    };
    c.prototype.removeAllEvListener = function() {
        this.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouched, this)
    };
    return c
} (egret.Sprite);
...
GameContainer = function(b) {
    function c(d, a) {
        b.call(this);
        this.fWidth = this.width = d;
        this.fHeight = a;
        this.height = 890 * this.fHeight / 1280;
        this.createView()
    }
    __extends(c, b);
    c.prototype.resetGameUI = function() {
        this.clearAllChild();
        this.createView()
    };
    c.prototype.clearAllChild = function() {
        for (var b = this.numChildren; b;) this.removeChildAt(b - 1),
        b--
    };
    c.prototype.writetxt = function() {
        this.paraphras = YYLib.Util.getTextField("\u6b63\u786e\u7b54\u6848\uff1a" + DataProxy.getInstance().curLvOk, 24, 8634562, "Microsoft Yahei", "left", "", !1, !0);
        this.paraphras.x = 20;
        this.paraphras.y = this.height - this.paraphras.height + 40;
        this.addChild(this.paraphras)
    };
    c.prototype.createView = function() {
        this.wordPanelbg = YYLib.Util.getBitmap("sprite.wordPanel");
        this.wordPanel = new egret.Sprite;
        this.wordPanel.width = this.wordPanelbg.width;
        this.wordPanel.height = this.wordPanelbg.height;
        this.wordPanel.x = (this.fWidth - this.wordPanel.width) / 2;
        this.wordPanel.y = 10;
        this.wordPanel.addChild(this.wordPanelbg);
        this.addChild(this.wordPanel);
        this.currLv = DataProxy.getInstance().gameData[DataProxy.getInstance().level];
        DataProxy.getInstance().curLvOk = this.currLv.ok;
        this.createWords();
        this.createAnswers();
        this.paraphrase = YYLib.Util.getTextField("\u672c\u8bcd\u89e3\u91ca\uff1a" + this.currLv.explain, 24, 8634562, "Microsoft Yahei", "left", "", !1, !0);
        this.paraphrase.x = 20;
        this.paraphrase.y = this.height - this.paraphrase.height;
        this.addChild(this.paraphrase)
    };
    c.prototype.createWords = function() {
        var b = this.currLv.cizu.length,
        a = 2 < b ? !0 : !1,
        c = 181 * b;
        a && (c = 100 * b);
        for (var c = (this.wordPanel.width - c) / 2, l = 0; l < b; l++) {
            var m = new egret.Sprite,
            h;
            h = a ? YYLib.Util.getBitmap("sprite.quesBlockSmall") : YYLib.Util.getBitmap("sprite.quesBlock");
            m.width = h.width;
            m.height = h.height;
            m.y = (this.wordPanel.height - m.height) / 2;
            m.x = c;
            c += m.width;
            m.addChild(h);
            h = 16756224;
            for (var g = 0; g < this.currLv.focus.length; g++) l == this.currLv.focus[g] && (h = 16711680);
            a ? (g = YYLib.Util.getTextField(this.currLv.pinyin[l], 32, h), h = YYLib.Util.getTextField(this.currLv.cizu[l], 64, h, null, "center", "middle"), h.height = 90) : (g = YYLib.Util.getTextField(this.currLv.pinyin[l], 36, h), h = YYLib.Util.getTextField(this.currLv.cizu[l], 100, h, null, "center", "middle"), h.height = 120);
            g.width = m.width;
            g.height = 60;
            g.x = 0;
            g.y = -3;
            h.width = m.width;
            h.y = a ? m.height - 95 : m.height - 125;
            m.addChild(g);
            m.addChild(h);
            this.wordPanel.addChild(m)
        }
    };
    c.prototype.createAnswers = function() {
        var b = this.currLv.focus.length;
        console.log("\u7b54\u6848\u957f\u5ea6\uff1a" + b);
        var a = ["A:", "B:", "C:", "D:"];
        console.log("\u9009\u9879\u4e2a\u6570\uff1a" + this.currLv.options.length);
        for (var c = this.wordPanel.y + this.wordPanel.height + 25,
        l = 0; l < this.currLv.options.length; l++) {
            var m = new egret.Sprite;
            if (1 === b) var m = 0 === l % 2 ? this.wordPanel.x: this.wordPanel.x + this.wordPanel.width - 260,
            h = c,
            m = new Grid("sprite.ansBlock", m, h, this.currLv.options[l], 72, a[l]),
            c = c + (1 === l ? m.height + 15 : 0);
            else m = (this.width - 560) / 2,
            h = c,
            m = new Grid("sprite.ansBlockLong", m, h, this.currLv.options[l], 36, a[l]),
            c += m.height + 15;
            this.currLv.options[l] == DataProxy.getInstance().curLvOk && (DataProxy.getInstance().theRightOne = m);
            this.addChild(m)
        }
    };
    c.prototype.gridOnTouched = function(b) {
        b = b.target;
        b.opts == DataProxy.getInstance().curLvOk ? b.ansRight.visible = !0 : b.ansError.visible = !1
    };
    c.prototype.removeAllEvListener = function() {};
    return c
...
function(b, c) {
    ...
    var c = function(b) {
        ...
        __extends(a, b);
        a.getBitmap = function(a) {
            var b = new egret.Bitmap;
            a = RES.getRes(a);
            b.texture = a;
            b.width = a.textureWidth;
            b.height = a.textureHeight;
            return b
        };
        a.getTextField = function(a, b, d, c, g, f, k, n) {
            var p = new egret.TextField;
            p.text = a;
            p.size = b || 12;
            p.textColor = d || 0;
            p.fontFamily = c || "Microsoft Yahei";
            p.textAlign = g || egret.HorizontalAlign.CENTER;
            p.verticalAlign = f || egret.VerticalAlign.MIDDLE;
            p.touchEnabled = k || !1;
            p.bold = n || !1;
            return p
        };
        a.setTxtBold = function(a) {
            a.bold = !0
        };
        a.clearAllChilds = function(a) {
            for (var b = a.numChildren; b;) a.removeChildAt(b - 1),
            b--
        };
        a.getStrSize = function(a) {
            for (var b = 0,
            d = a.length,
            c = -1,
            g = 0; g < d; g++) c = a.charCodeAt(g),
            b = 0 <= c && 128 >= c ? b + 1 : b + 2;
            return b
        };
        a.isWeChat = function() {
    ...
    b.Util = c;
    c.prototype.__class__ = "YYLib.Util"
})(YYLib || (YYLib = {}));
var __extends = this.__extends ||
function(b, c) {
    function d() {
...
DataProxy = function(b) {
    function c() {
        b.call(this);
        this.level = 0;
        this.totalTime = 20;
        this.gameScore = 0;
        this.progressTime = 200;
        this._curLvOptions = [];
        this.curLvOk = "";
        this.gameData = [];
        this.numCN = "\u4e00 \u4e8c \u4e09 \u56db \u4e94 \u516d \u4e03 \u516b \u4e5d \u5341 \u5341\u4e00 \u5341\u4e8c \u5341\u4e09 \u5341\u56db \u5341\u4e94 \u5341\u516d \u5341\u4e03 \u5341\u516b".split(" ");
        this.historyData = {
            score: 0,
            times: 0,
            rank: -1
    ...
    c.prototype.getResultData = function() {
        var b = [];
        if (4 > this.gameScore) {
            var a = (new Number(90 + 10 * Math.random())).toFixed(2);
            b.push("\u6709" + a + "%\u5c0f\u5b66\u751f\u8d85\u8d8a\u4e86\u4f60");
            b.push(1);
            b.push("\u5f31\u5b57")
        } else if (4 <= this.gameScore && 7 > this.gameScore) a = (new Number(45 + 3 * (this.gameScore + 1) + Math.random())).toFixed(2),
        b.push("\u52c9\u5f3a\u8d85\u8fc7\u4e86\u5168\u56fd" + a + "%\u7684\u5c0f\u5b66\u751f"),
        b.push(2),
        b.push("\u5b57\u9b3c");
        else if (a = this.gameScore, 17 < a && (a = 17), a = (new Number(45 + 3 * (a + 1) + Math.random())).toFixed(2), b.push("\u8d85\u8d8a\u4e86" + a + "%\u7684\u5c0f\u4f19\u4f34"), 7 <= this.gameScore && 10 > this.gameScore) b.push(3),
        b.push("\u5b57\u7cbe");
        else if (10 <= this.gameScore && 13 > this.gameScore) b.push(4),
        b.push("\u5b57\u9738");
        else switch (b.push(5), this.gameScore) {
        case 12:
            b.push("\u4e00\u7ea7\u5b57\u795e");
            break;
        case 13:
        ...
        b.push("\u4f60\u7684\u5b57\u9b54\u6307\u6570\u662f\uff1a" + (this.gameScore + 1));
        b.push(this.gameScore);
        window.shareData.tContent = "\u6211\u8ba4\u51fa" + (this.gameScore + 1) + "\u4e2a\u9b54\u5b57\uff0c\u88ab\u5c01\u4e3a\u201c" + this.getName(this.gameScore) + "\u201d\uff01\u4f60\u6562\u6765\u8bd5\u8bd5\u5417\uff1f";
        return b
    };
    c.prototype.getName = function(b) {
        if (0 <= b && 3 > b) return "\u3010\u5f31\u5b57\u3011";
        if (3 <= b && 6 > b) return "\u3010\u5b57\u9b3c\u3011";
        if (6 <= b && 9 > b) return "\u3010\u5b57\u7cbe\u3011";
        if (9 <= b && 12 > b) return "\u3010\u5b57\u9738\u3011";
        switch (b) {
        case 12:
            return "\u3010\u4e00\u7ea7\u5b57\u795e\u3011";
        case 13:
    ...
    Object.defineProperty(c.prototype, "curLvOptions", {
        get: function() {
            return this._curLvOptions
        },
        set: function(b) {
            this._curLvOptions = b;
            this.curLvOk = b.ok;
            console.log("\u66f4\u65b0\u5173\u5361\u4fe1\u606f", this.curLvOk)
        },
        enumerable: !0,
        configurable: !0
    });
    c.getInstance = function() {
        c.g_instance || (c.g_instance = new c);
        return c.g_instance
    };
    return c
} (egret.DisplayObject);
DataProxy.prototype.__class__ = "DataProxy";
var __extends = this.__extends ||
function(b, c) {
    function d() {
        this.constructor = b
...
LoadingUI = function(b) {
    ...
    c.prototype.createView = function() {
        ...
        this.textField.y = this.textField.x = 0;
        this.textField.width = this.fWidth;
        this.textField.height = this.fHeight;
...
DuraPage = function(b) {
    ...
    __extends(c, b);
    c.prototype.createView = function() {
        var b = YYLib.Util.getBitmap("sprite.durBg");
        b.x = (this.width - b.width) / 2;
        b.y = (this.height - b.height) / 2;
        this.addChild(b);
        var a = YYLib.Util.getTextField("\u9b54\u5b5718", 60, 5744039);
        a.bold = !0;
        a.width = this.width;
        a.height = 80;
        a.x = 0;
        a.y = b.y - a.height;
        this.addChild(a);
        a = YYLib.Util.getTextField("\u8bf7\u4e3a\u7ea2\u8272\u7684\u5b57\u9009\u62e9\u6b63\u786e\u7684\u8bfb\u97f3", 48, 13054222);
        a.bold = !0;
        a.width = 350;
        a.height = 120;
...
DuraPage.prototype.__class__ = "DuraPage";
var __extends = this.__extends ||
function(b, c) {
    function d() {
        this.constructor = b
...
Footer = function(b) {
    function c(d, a) {
        ...
        this.fWidth = this.width = d;
        this.fHeight = a;
        this.height = 90 * this.fHeight / 1280;
        this.createView()
    }
    __extends(c, b);
    c.prototype.createView = function() {
        this.bg = YYLib.Util.getBitmap("sprite.bottomTexture");
        this.bg.x = this.width - this.bg.width;
        console.log("this.bg.height", this.bg.height);
...
Footer.prototype.__class__ = "Footer";
var __extends = this.__extends ||
function(b, c) {
    function d() {
        this.constructor = b
...
Header = function(b) {
    function c(d, a) {
        b.call(this);
        this.addScore = YYLib.Util.getTextField("+1", 36, 13500293);
        this.time = 0;
        this.width = this.fWidth = d;
        this.fHeight = a;
        this.height = 300 * this.fHeight / 1280;
        this.createView()
    }
    __extends(c, b);
    c.prototype.createView = function() {
        this.returnIcon = YYLib.Util.getBitmap("sprite.returnIcon");
        this.returnIcon.x = this.returnIcon.y = 20;
        this.returnIcon.touchEnabled = !0;
        this.returnIcon.addEventListener(egret.TouchEvent.TOUCH_TAP, this.returnIconTouched, this);
        this.addChild(this.returnIcon);
        this.replayIcon = YYLib.Util.getBitmap("sprite.replayIcon");
        this.replayIcon.x = this.fWidth - this.replayIcon.width - 20;
        this.replayIcon.y = 20;
        this.replayIcon.touchEnabled = !0;
        this.replayIcon.addEventListener(egret.TouchEvent.TOUCH_TAP, this.replayIconTouched, this);
        this.addChild(this.replayIcon);
        this.clock = new egret.Sprite;
        this.clockBg = YYLib.Util.getBitmap("sprite.clock");
        this.clock.width = this.clockBg.width;
        this.clock.height = this.clockBg.height;
        this.clockBg.x = this.clockBg.y = 0;
        this.clock.addChild(this.clockBg);
        this.clock.x = (this.fWidth - this.clock.width) / 2;
        this.clockCircle = new egret.Sprite;
        this.clockCircle.width = this.clockCircle.height = 108;
        this.clockCircle.x = (this.clock.width - this.clockCircle.width) / 2;
        this.clockCircle.y = 15;
        this.clockTime = YYLib.Util.getTextField("20", 60, 16756224);
        this.clockTime.width = this.clockCircle.width;
        this.clockTime.height = this.clockCircle.height;
        this.clockTime.x = this.clockTime.y = 0;
        this.clockCircle.addChild(this.clockTime);
        this.clock.addChild(this.clockCircle);
        this.historyScoreBg = YYLib.Util.getBitmap("sprite.optPanel");
        this.historyScoreBg.x = this.fWidth / 2 - this.historyScoreBg.width - 10;
        this.historyScoreBg.y = this.height - this.historyScoreBg.height;
        this.addChild(this.historyScoreBg);
        this.clock.y = this.height - this.historyScoreBg.height - this.clock.height - 10;
        this.addChild(this.clock);
        this.historyTitle = YYLib.Util.getTextField("\u5386\u53f2\u6700\u9ad8", 24, 5276824);
        this.historyTitle.height = this.historyScoreBg.height;
        this.historyTitle.width = 100;
        this.historyTitle.x = this.historyScoreBg.x + 20;
        this.historyTitle.y = this.historyScoreBg.y;
        this.addChild(this.historyTitle);
        this._historyScore = YYLib.Util.getTextField("" + DataProxy.getInstance().historyData.score, 36, 16777215, "Microsoft Yahei", egret.HorizontalAlign.LEFT);
        this._historyScore.width = this.historyScoreBg.width - this.historyTitle.width - 20;
        this._historyScore.height = this.historyScoreBg.height;
        this._historyScore.x = this.historyTitle.x + this.historyTitle.width + 5;
        this._historyScore.y = this.historyTitle.y;
        this.addChild(this._historyScore);
        this.currScoreBg = YYLib.Util.getBitmap("sprite.optPanel");
        this.currScoreBg.x = this.fWidth / 2 + 10;
        this.currScoreBg.y = this.historyScoreBg.y;
        this.addChild(this.currScoreBg);
        this.currTitle = YYLib.Util.getTextField("\u5f53\u524d\u5f97\u5206", 24, 5276824);
        this.currTitle.height = this.currScoreBg.height;
        this.currTitle.width = 100;
        this.currTitle.x = this.currScoreBg.x + 20;
        this.currTitle.y = this.currScoreBg.y;
        this.addChild(this.currTitle);
        this._currScore = YYLib.Util.getTextField("" + DataProxy.getInstance().level, 36, 16777215, "Microsoft Yahei", egret.HorizontalAlign.LEFT);
        this._currScore.width = this.currScoreBg.width - this.currTitle.width - 20;
        this._currScore.height = this.currScoreBg.height;
        this._currScore.x = this.currTitle.x + this.currTitle.width + 5;
        this._currScore.y = this.currTitle.y;
        this.addChild(this._currScore);
        this.addScore.y = this._currScore.y;
        this.addScore.x = this.currScoreBg.x + this.currScoreBg.width - this.addScore.width;
        this.addScore.visible = !1;
        this.addChild(this.addScore);
        this.timer = new egret.Timer(200, 0);
        this.timer.addEventListener(egret.TimerEvent.TIMER, this.setProgress, this);
        this.timer.start()
    };
    c.prototype.playAddScore = function() {
        var b = this,
        a = egret.Tween.get(this.addScore),
        c = this.addScore.y;
        this.addScore.visible = !0;
        a.to({
            alpha: 0,
            y: this.addScore.y - 20
        },
        1E3);
        a.call(function() {
            b.addScore.y = c;
            b.addScore.visible = !1;
            b.addScore.alpha = 1
        })
    };
    c.prototype.resetGameData = function() {
        this.time = 0
    };
    c.prototype.returnIconTouched = function() {
        var b = new YYLib.YYEvents("goHome");
        this.dispatchEvent(b)
    };
    c.prototype.replayIconTouched = function() {
        var b = new YYLib.YYEvents("replayGame");
        this.dispatchEvent(b)
    };
    c.prototype.removeAllEvListener = function() {
        this.returnIcon.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.returnIconTouched, this);
        this.replayIcon.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.replayIconTouched, this)
    };
    c.prototype.setProgress = function() {
        this.time += 200;
        var b = DataProxy.getInstance().totalTime,
        a = 2 * Math.PI * this.time / (1E3 * b);
        this.clockTime.text = "" + (b - Math.floor(this.time / 1E3));
        a >= 3 * Math.PI / 2 ? (this.clockCircle.graphics.clear(), this.clockCircle.graphics.lineStyle(6, 16711680)) : (this.clockCircle.graphics.clear(), this.clockCircle.graphics.lineStyle(6, 10275418));
        this.clockCircle.graphics.beginFill(0, 0);
        a >= 2 * Math.PI && (this.timer.stop(), b = new YYLib.YYEvents("gameTimeout"), this.dispatchEvent(b));
        this.clockCircle.graphics.arc(this.clockCircle.width / 2, this.clockCircle.height / 2, 51, -Math.PI / 2, a - Math.PI / 2)
    };
    Object.defineProperty(c.prototype, "currScore", {
        get: function() {
            return parseInt(this._currScore.text, 10)
        },
        set: function(b) {
            this._currScore.text = "" + b;
            this.playAddScore();
            b > DataProxy.getInstance().historyData.score && (DataProxy.getInstance().historyData.score = this.historyScore = b)
        },
        enumerable: !0,
        configurable: !0
    });
    Object.defineProperty(c.prototype, "historyScore", {
        get: function() {
            return parseInt(this._historyScore.text, 10)
        },
        set: function(b) {
            this._historyScore.text = "" + b
        },
        enumerable: !0,
        configurable: !0
    });
...
Header.prototype.__class__ = "Header";
var __extends = this.__extends ||
function(b, c) {
    function d() {
        this.constructor = b
...
ResultPage = function(b) {
    function c(d, a) {
        b.call(this);
        this.resLeftTitle = YYLib.Util.getTextField("\u83b7\u5f97", 40, 12943931);
        this.resRightTitle = YYLib.Util.getTextField("\u79f0\u53f7", 40, 12943931);
        this.width = this.fWidth = d;
        this.fHeight = a;
        this.height = 1160 * this.height / 1280;
        this.container = new egret.Sprite;
        this.container.graphics.beginFill(11265511);
        this.container.graphics.drawRect(0, 0, this.fWidth, this.fHeight);
        this.container.graphics.endFill();
        this.createView();
        this.addChild(this.container)
    }
    __extends(c, b);
    c.prototype.createTopPanel = function() {
        var b = DataProxy.getInstance().getResultData();
        this.topPanel = new egret.Sprite;
        this.topPanel.width = this.width;
        this.topPanel.height = 620 * this.fHeight / 1280;
        this.topPanel.x = this.topPanel.y = 0;
        this.resultPanel = YYLib.Util.getBitmap("sprite.resultPanel");
        this.resultPanel.height *= 0.65;
        this.resultPanel.x = (this.width - this.resultPanel.width) / 2;
        this.resultPanel.y = this.topPanel.height - this.resultPanel.height;
        this.topPanel.addChild(this.resultPanel);
        this.resultIcon = YYLib.Util.getBitmap("result.result" + b[1]);
        this.resultIcon.x = (this.topPanel.width - this.resultIcon.width) / 2;
        this.resultIcon.y = this.resultPanel.y - this.resultIcon.height + 45;
        this.topPanel.addChild(this.resultIcon);
        var a = YYLib.Util.getTextField("" + b[4], 50, 8501553);
        a.x = (this.topPanel.width - a.width) / 2 + 55;
        a.y = this.resultPanel.y + 20;
        this.topPanel.addChild(a);
        var c = YYLib.Util.getTextField("\u4f60\u603b\u5171\u7b54\u5bf9", 30, 12943931),
        l = YYLib.Util.getTextField("\u9053\u9898", 30, 12943931);
        c.x = a.x - c.width - 10;
        l.x = a.x + a.width + 10;
        c.y = l.y = a.y + a.height - c.height;
        this.topPanel.addChild(c);
        this.topPanel.addChild(l);
        this.resName = YYLib.Util.getTextField("" + b[2], 60, 16711680);
        this.resName.x = (this.topPanel.width - this.resName.width) / 2;
        this.resName.y = this.resultPanel.y + 100;
        this.topPanel.addChild(this.resName);
        this.resLeftTitle.x = this.resName.x - this.resLeftTitle.width;
        this.resRightTitle.x = this.resName.x + this.resName.width;
        this.resLeftTitle.y = this.resRightTitle.y = this.resName.y + this.resName.height - this.resLeftTitle.height;
        this.topPanel.addChild(this.resLeftTitle);
        this.topPanel.addChild(this.resRightTitle);
        this.resDesc = YYLib.Util.getTextField(b[3] + "\n" + b[0], 30, 12943931);
        this.resDesc.width = 500;
        this.resDesc.lineSpacing = 20;
        this.resDesc.x = (this.topPanel.width - this.resDesc.width) / 2;
        this.resDesc.y = this.resName.y + this.resName.height + 40;
        this.topPanel.addChild(this.resDesc);
        this.container.addChild(this.topPanel);
        window.PageApp.saveData2Local({
            times: 1,
            score: DataProxy.getInstance().historyData.score,
            rank: DataProxy.getInstance().level > DataProxy.getInstance().historyData.rank ? DataProxy.getInstance().level: DataProxy.getInstance().historyData.rank
        })
    };
    c.prototype.createBotmPanel = function() {
        this.botmPanel = new egret.Sprite;
        this.botmPanel.width = this.width;
        this.botmPanel.height = 380 * this.fHeight / 1280;
        this.botmPanel.x = 0;
        this.botmPanel.y = 620 * this.fHeight / 1280;
        this.container.addChild(this.botmPanel);
        this.replayBtn = new egret.Sprite;
        this.replayBtnBg = YYLib.Util.getBitmap("sprite.greenBtn");
        this.replayBtn.width = this.replayBtnBg.width;
        this.replayBtn.height = this.replayBtnBg.height;
        this.replayBtn.addChild(this.replayBtnBg);
        var b = YYLib.Util.getTextField("\u518d\u6765\u4e00\u5c40", 48, 16777215);
        b.width = this.replayBtn.width;
        b.height = this.replayBtn.height;
        this.replayBtn.addChild(b);
        this.replayBtn.touchChildren = !1;
        this.replayBtn.touchEnabled = !0;
        this.replayBtn.y = 30;
        this.replayBtn.x = this.width / 2 - this.replayBtn.width - 10;
        this.replayBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.replayBtnTouched, this);
        this.botmPanel.addChild(this.replayBtn);
        this.goHomeBtn = new egret.Sprite;
        this.goHomeBtnBg = YYLib.Util.getBitmap("sprite.greenBtn");
        this.goHomeBtn.width = this.goHomeBtnBg.width;
        this.goHomeBtn.height = this.goHomeBtnBg.height;
        this.goHomeBtn.addChild(this.goHomeBtnBg);
        b = YYLib.Util.getTextField("\u56de\u5230\u9996\u9875", 48, 16777215);
        b.width = this.goHomeBtn.width;
        b.height = this.goHomeBtn.height;
        this.goHomeBtn.addChild(b);
        this.goHomeBtn.touchChildren = !1;
        this.goHomeBtn.touchEnabled = !0;
        this.goHomeBtn.y = 30;
        this.goHomeBtn.x = this.width / 2 + 10;
        this.goHomeBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.goHomeBtnTouched, this);
        this.botmPanel.addChild(this.goHomeBtn);
        if (window.EgretUtil.isApp() || window.EgretUtil.isQQ() || window.EgretUtil.isWeiXin()) this.shareBtn = new egret.Sprite,
        this.shareBtnBg = YYLib.Util.getBitmap("sprite.orangeBtn"),
        this.shareBtn.width = this.shareBtnBg.width,
        this.shareBtn.height = this.shareBtnBg.height,
        this.shareBtn.addChild(this.shareBtnBg),
        b = YYLib.Util.getTextField("\u5206 \u4eab", 48, 16777215),
        b.width = this.shareBtn.width,
        b.height = this.shareBtn.height,
        this.shareBtn.addChild(b),
        this.shareBtn.touchChildren = !1,
        this.shareBtn.touchEnabled = !0,
        this.shareBtn.x = (this.width - this.shareBtn.width) / 2,
        this.shareBtn.y = this.replayBtn.y + this.replayBtn.height + 20,
        this.shareBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.shareBtnTouched, this),
        this.botmPanel.addChild(this.shareBtn)
    };
    c.prototype.replayBtnTouched = function() {
        var b = new YYLib.YYEvents("replayGame");
        this.dispatchEvent(b)
    };
    c.prototype.goHomeBtnTouched = function() {
        var b = new YYLib.YYEvents("goHomeBtnTouched");
        this.dispatchEvent(b)
    };
    c.prototype.shareBtnTouched = function() {
        var b = new YYLib.YYEvents("shareBtnTouched");
        this.dispatchEvent(b)
    };
    c.prototype.openMoreGameTouched = function() {
        window.openMoreGame()
    };
    c.prototype.removeAllEvListener = function() {
        this.replayBtn.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.replayBtnTouched, this);
        this.goHomeBtn.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.goHomeBtnTouched, this);
        this.shareBtn && this.shareBtn.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.shareBtnTouched, this);
        this.contains(this.openMoreGame) && this.openMoreGame.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.openMoreGameTouched, this)
    };
    c.prototype.createView = function() {
        //window.kkdict && window.kkdict.stopBackgroundSound ? window.kkdict.stopBackgroundSound() : RES.getRes("sound").pause();
        this.createTopPanel();
        this.createBotmPanel()
    };
    return c
} (egret.DisplayObjectContainer);
...
StartPage = function(b) {
    function c(d, a) {
        b.call(this);
        this.helpDesc = "\u4f20\u8bf4\uff0c\u4ece\u6765\u6ca1\u6709\u4eba\u80fd\u901a\u8fc7\u5341\u516b\u5c42\u8003\u9a8c\uff0c\u8ba4\u51fa\u6240\u6709\u7684\u201c\u9b54\u5b57\u201d\uff01\u4f60\uff0c\u53ef\u4ee5\u5417\uff1f";
        this.width = this.fWidth = d;
    ...
    c.prototype.createTopBar = function() {
        this.topBar = new egret.Sprite;
        this.topBar.width = this.width;
        this.topBar.height = 95;
        this.topBar.graphics.beginFill(15790320);
        this.topBar.graphics.drawRect(0, 0, this.width, this.topBar.height);
        this.topBar.graphics.endFill();
        this.topBarTitle = YYLib.Util.getTextField("\u9b54\u5b5718", 38, 16726832);
        this.topBarTitle.width = this.width;
        this.topBarTitle.height = this.topBar.height;
        this.topBar.addChild(this.topBarTitle);
        window.isKKclient && window.isKKclient() && (this.returnIcon = YYLib.Util.getBitmap("sprite.goHomeIcon"), this.returnIcon.x = this.returnIcon.y = 0, this.returnIcon.touchEnabled = !0, this.returnIcon.addEventListener(egret.TouchEvent.TOUCH_TAP, this.returnIconTouched, this), this.topBar.addChild(this.returnIcon));
        this.topBar.x = this.topBar.y = 0;
        this.addChild(this.topBar)
    };
    c.prototype.addStartBtn = function() {
        this.startBtn = new egret.Sprite;
        var b = YYLib.Util.getBitmap("sprite.redBtn");
        this.startBtn.width = b.width;
        this.startBtn.height = b.height;
        this.startBtn.x = (this.width - this.startBtn.width) / 2;
        this.startBtn.y = this.height - this.startBtn.height - 30;
        this.startBtn.addChild(b);
        b = YYLib.Util.getTextField("\u9a6c\u4e0a\u5f00\u59cb", 48, 16777215);
        b.width = this.startBtn.width;
        b.height = this.startBtn.height;
        this.startBtn.addChild(b);
        this.startBtn.touchEnabled = !0;
        this.startBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.startBtnTouched, this);
        this.addChild(this.startBtn)
    };
    c.prototype.createContent = function() {
        DataProxy.getInstance().historyData = window.PageApp.getLocalData() || DataProxy.getInstance().historyData;
        this.bg = YYLib.Util.getBitmap("sprite.homeBg");
        this.bg.x = 0;
        this.bg.y = 95;
        this.addChild(this.bg);
        this.helpTitle = YYLib.Util.getTextField("\u73a9\u6cd5\u7b80\u4ecb:", 38, 16726832);
        this.helpTitle.x = 40;
        this.helpTitle.y = this.bg.y + this.bg.height + 50;
        this.addChild(this.helpTitle);
        this.helpTxt = YYLib.Util.getTextField(this.helpDesc, 32, 0, null, egret.HorizontalAlign.LEFT);
        this.helpTxt.width = 640;
        this.helpTxt.height = 80;
        this.helpTxt.lineSpacing = 10;
        this.helpTxt.x = 40;
        this.helpTxt.y = this.helpTitle.y + this.helpTitle.height + 10;
        this.addChild(this.helpTxt);
        this.levelTitle = YYLib.Util.getTextField("\u6700\u4f73\u6210\u7ee9\uff1a", 38, 16726832, null, egret.HorizontalAlign.LEFT);
        this.levelTitle.x = 40;
        this.levelTitle.y = this.helpTxt.y + this.helpTxt.height + 20;
        this.levelTitle.width = 190;
        this.addChild(this.levelTitle);
        console.log("rank:" + DataProxy.getInstance().historyData.rank);
        var b = DataProxy.getInstance().getName(DataProxy.getInstance().historyData.rank);
        console.log("\u79f0\u53f7\uff1a" + DataProxy.getInstance().getName(DataProxy.getInstance().historyData.rank));
        this.levelTxt = YYLib.Util.getTextField(b, 38, 16756224, null, egret.HorizontalAlign.LEFT);
        this.levelTxt.width = 300;
        this.levelTxt.y = this.levelTitle.y;
        this.levelTxt.x = this.levelTitle.x + this.levelTitle.width + 5;
        this.addChild(this.levelTxt);
        this.countTitle = YYLib.Util.getTextField("\u6e38\u620f\u6b21\u6570\uff1a", 38, 16726832, null, egret.HorizontalAlign.LEFT);
        this.countTitle.width = 190;
        this.countTitle.x = 40;
        this.countTitle.y = this.levelTitle.y + this.levelTitle.height + 20;
        this.addChild(this.countTitle);
        this.countTxt = YYLib.Util.getTextField(DataProxy.getInstance().historyData.times || "0", 38, 0, null, egret.HorizontalAlign.LEFT);
        this.countTxt.width = 300;
        this.countTxt.y = this.countTitle.y;
        this.countTxt.x = this.countTitle.width + this.countTitle.x + 5;
        this.addChild(this.countTxt)
    };
    c.prototype.removeAllEventListener = function() {
        this.startBtn.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.startBtnTouched, this)
    };
    c.prototype.returnIconTouched = function() {
        var b = new YYLib.YYEvents("returnAppHome");
        this.dispatchEvent(b)
    };
    c.prototype.startBtnTouched = function() {
        var b = new YYLib.YYEvents("startGame");
        this.dispatchEvent(b)
    };
    return c
} (egret.DisplayObjectContainer);
...
myMap; (function(b) {
    ...
    b[b.focus = 2] = "focus";
    b[b.pinyin = 3] = "pinyin";
    b[b.explain = 4] = "explain";
    b[b.options = 5] = "options"
})(myMap || (myMap = {}));
var Main = function(b) {
    function c() {
        b.call(this);
    ...
    c.prototype.onResourceLoadComplete = function(b) {
        "preload" == b.groupName && (this.stage.removeChild(this.loadingView), RES.removeEventListener(RES.ResourceEvent.GROUP_COMPLETE, this.onResourceLoadComplete, this), RES.removeEventListener(RES.ResourceEvent.GROUP_PROGRESS, this.onResourceProgress, this), this.createStartPage())
    };
    c.prototype.onResourceProgress = function(b) {
        "preload" == b.groupName && this.loadingView.setProgress(b.itemsLoaded, b.itemsTotal)
    };
    c.prototype.createStartPage = function() {
        this.startPage = new StartPage(this.stage.stageWidth, this.stage.stageHeight);
        this.startPage.addEventListener("startGame", this.enterDuraPage, this);
        this.startPage.addEventListener("returnAppHome", this.returnAppHome, this);
        this.addChild(this.startPage)
    };
    c.prototype.createGameScene = function() {
        console.log("\u521b\u5efa\u6e38\u620f\u573a\u666f");
        this.contains(this.duraPage) && this.removeChild(this.duraPage);
        this.clearResultPage();
        this.header = new Header(this.stage.stageWidth, this.stage.stageHeight);
        this.header.x = this.header.y = 0;
        this.header.addEventListener("gameTimeout", this.showResultPage, this);
        this.header.addEventListener("replayGame", this.replayGame, this);
        this.header.addEventListener("goHome", this.goHome, this);
        DataProxy.getInstance().gameContainer = this.gameContainer = new GameContainer(this.stage.stageWidth, this.stage.stageHeight);
        this.gameContainer.x = 0;
        this.gameContainer.y = this.header.height + this.header.y;
        this.gameContainer.addEventListener("ansRight", this.ansRight, this);
        this.gameContainer.addEventListener("ansError", this.ansError, this);
        this.addChild(this.gameContainer);
        this.addChild(this.header)
    };
    c.prototype.enterDuraPage = function() {
        var b = this;
        b.clearStartPage();
        b.duraPage = new DuraPage(b.stage.stageWidth, b.stage.stageHeight);
        b.addChild(b.duraPage);
        b.footer = new Footer(b.stage.stageWidth, b.stage.stageHeight);
        b.footer.x = 0;
        b.footer.y = b.stage.stageHeight - b.footer.height;
        b.addChild(b.footer);
        window.PageApp.getGameData(function(a) {
            DataProxy.getInstance().gameData = a.subjects;
            a = egret.Tween.get(b.duraPage);
            a.to({
                alpha: 0
            },
            3E3);
            a.call(b.createGameScene, b)
        })
    };
    c.prototype.showResultPage = function() {
        this.delayResPageTimer && (this.delayResPageTimer.stop(), this.delayResPageTimer.removeEventListener(egret.TimerEvent.TIMER_COMPLETE, this.showResultPage, this), this.delayResPageTimer = null);
        this.clearHeader();
        this.clearGameContainer();
        this.resultPage = new ResultPage(this.stage.stageWidth, this.stage.stageHeight);
        this.resultPage.addEventListener("replayGame", this.replayGameFromRsPage, this);
        this.resultPage.addEventListener("goHomeBtnTouched", this.goHome, this);
        this.resultPage.addEventListener("shareBtnTouched", this.shareGame, this);
        this.addChild(this.resultPage)
    };
    c.prototype.replayGame = function() {
        var b = this;
        window.PageApp.getGameData(function(a) {
            DataProxy.getInstance().gameData = a.subjects;
            b.header.resetGameData();
            b.gameContainer.resetGameUI()
        })
    };
    c.prototype.replayGameFromRsPage = function(b) {
        var a = this;
        window.PageApp.getGameData(function(b) {
            DataProxy.getInstance().gameData = b.subjects;
            DataProxy.getInstance().resetData();
            a.createGameScene()
        })
    };
    c.prototype.nextLevel = function(b) {
        console.log("\u8fdb\u5165\u4e0b\u4e00\u5173");
        DataProxy.getInstance().level++;
        17 < DataProxy.getInstance().level ? this.showResultPage() : this.gameContainer.resetGameUI()
    };
    c.prototype.ansRight = function(b) {
        console.log("\u7b54\u5bf9\u4e86");
        this.header.currScore += 1;
        DataProxy.getInstance().level++;
        DataProxy.getInstance().gameScore++;
        17 < DataProxy.getInstance().level ? this.showResultPage() : this.gameContainer.resetGameUI()
    };
    c.prototype.ansError = function(b) {
        console.log("\u7b54\u9519\u4e86");
        var a = this;
        b = new egret.Timer(1E3, 1);
        b.addEventListener(egret.TimerEvent.TIMER_COMPLETE,
        function() {
            DataProxy.getInstance().theRightOne.ansRight.visible = !0;
            DataProxy.getInstance().theRightOne.ansRight.alpha = 1;
            a.gameContainer.writetxt();
            a.delayResPageTimer = new egret.Timer(1500, 1);
            a.delayResPageTimer.addEventListener(egret.TimerEvent.TIMER_COMPLETE, this.nextLevel, this);
            a.delayResPageTimer.start()
        },
        this);
        b.start()
    };
    c.prototype.goHome = function() {
        window.hideTips4WeChat();
        this.clearResultPage();
        this.clearHeader();
        this.clearGameContainer();
    ...
    c.prototype.clearStartPage = function() {
        this.contains(this.startPage) && (this.startPage.removeEventListener("startGame", this.enterDuraPage, this), this.startPage.removeEventListener("returnAppHome", this.returnAppHome, this), this.removeChild(this.startPage))
    };
    c.prototype.clearResultPage = function() {
        this.contains(this.resultPage) && (this.resultPage.removeAllEvListener(), this.resultPage.removeEventListener("replayGame", this.replayGameFromRsPage, this), this.resultPage.removeEventListener("goHomeBtnTouched", this.goHome, this), this.resultPage.removeEventListener("shareBtnTouched", this.shareGame, this), this.removeChild(this.resultPage))
    };
    c.prototype.clearHeader = function() {
        this.contains(this.header) && (this.header.removeAllEvListener(), this.header.removeEventListener("gameTimeout", this.showResultPage, this), this.header.removeEventListener("replayGame", this.replayGame, this), this.header.removeEventListener("goHome", this.goHome, this), this.removeChild(this.header))
    };
    c.prototype.clearGameContainer = function() {
        this.contains(this.gameContainer) && (this.gameContainer.removeEventListener("ansRight", this.ansRight, this), this.gameContainer.removeEventListener("ansError", this.ansError, this), this.removeChild(this.gameContainer))
    };
    c.prototype.shareGame = function() {
        window.PageApp.shareGame()
    };
    c.prototype.returnAppHome = function() {
        window.PageApp.returnAppHome()
    };
    return c
} (egret.DisplayObjectContainer);
